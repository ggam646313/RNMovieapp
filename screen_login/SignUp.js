            ...
            <View style={style.root}>
                ...
                <View style={style.content}>
                    ...
                    <View style={style.tabContainer}>
                        {/* Tab 버튼은 다른 곳에서도 사용하기 때문에 별도의 component로 만들어서 재사용 */}
                        {/* 선택 탭이 어느것인지 제어할 수 있도록 탭들을 배열로 관리 */}
                    ...
                    {/* 1.3 이메일 탭일때(tabIndex==1)는 비밀번호 입력칸도 있어야 함 */}
                    {
                        // if(this.state.tabIndex===1) // if문법 사용불가

                        // &&연산자를 통해 앞의 조건의 true일때 && 다음 코드가 실행되도록
                    ...
                    {/* 1.6 전화번호 탭일때 안내메세지 */}
                    {
                        this.state.tabIndex===0 && <Text style={style.telMessage}>MovieAPP의 업데이트 내용을 SMS로 수신할 수 있으며, 수신을 취소할 수 있습니다.</Text>
                    }
